...
let actionLongestWaitThenMoveRight = SKAction.sequence([actionFiveSecondWait,actionFiveSecondWait,actionFiveSecondWait,actionFiveSecondWait,actionRightMovement])

circle1.run(actionLongestWaitThenMoveRight)

// Exercise 2: Write your code below.
//create left movement
let leftThisMuch = CGVector(dx: -100, dy: 0)

let actionLeftMovement = SKAction.move(by: leftThisMuch, duration: 0.5)

let actionLongestWaitThenMoveUpandLeft = SKAction.sequence([actionFiveSecondWait,actionFiveSecondWait,actionFiveSecondWait,actionFiveSecondWait,actionUpwardsMovement,actionLeftMovement])

circle2.run(actionLongestWaitThenMoveUpandLeft)

// Exercise 3: Write your code below.
let diagonalmovement = CGVector(dx: 200, dy: 100)

let actionLargeMovement = SKAction.move(by: diagonalmovement, duration: 0.5)

let chaos = SKAction.sequence([actionFiveSecondWait,actionLargeMovement,actionFiveSecondWait,actionRightMovement,actionFiveSecondWait,actionLeftMovement,actionFiveSecondWait,actionLargeMovement])
